...
import ConatctDetail from '../contact/ConatctDetail'
  ...
  return (
    <div>
      <div className='NavBarMain'>
        <div onClick={() => navigate("/")}><p className='FontStyleNav'>GMC E-commerce</p></div>
        ...
        <div onClick={() => navigate("../Conatct/ConatctDetail")} id="home1">Conatct</div>
        ...
        }
        {
          isAuth === true ? <div className='NavbarAvtar dropdown' >
            ...
            <div onClick={() => navigate("../Conatct/ConatctDetail")} id="home1">Profile</div>
            ...
            <div>
              <div class="dropdown">
                <div className='name'><Avatar src="https://th.bing.com/th/id/OIP.z8-GqzZcw5PZgZkcGisFOAAAAA?w=166&h=180&c=7&r=0&o=5&dpr=1.25&pid=1.7" /></div>
                <div className='dropdown-content'>
                  <a href="#" onClick={handleLogin}>Profile</a>
                </div>
              </div>
            </div>
        }
